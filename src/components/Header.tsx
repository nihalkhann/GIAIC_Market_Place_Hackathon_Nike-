...
// import CartIndicater from "./ui/CartIndicater";
// import WishlistIndicator from "./ui/WishLishIndicater";
...
import CartIndicater from "./ui/CartIndicater";
import WishlistIndicator from "./ui/WishLishIndicater";
import SearchModal from "@/components/Search"; // Import the modal
import { useState } from "react";
import { SignedIn, SignedOut, SignInButton, UserButton } from "@clerk/nextjs";


const Header: React.FC = () => {
  const [isSearchModalOpen, setIsSearchModalOpen] = useState(false); // State for managing modal visibility
  ...
  const closeSearchModal = () => {
    ...
    return (
      <>
        <header>
          <div className="flex items-center justify-between px-6 py-2 bg-[#F5F5F5] text-gray-500 text-xs md:text-sm font-medium">
            {/* Left Section: Jordan Logos */}
            ...
            {/* Right Section: Links and Authentication */}
          ...
          <div className="flex flex-wrap justify-between items-center bg-white px-4 md:px-8 py-4">
            ...
            {/* Center Section (Navigation Links) */}
            <nav className="hidden md:flex gap-6 text-md font-bold text-gray-900">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                <input
                  ...
                  type="text"
                  placeholder="Search"
                  className=" bg-[#E5E5E5]  text-gray-600 rounded-full pl-10 py-2 text-sm w-36 focus:outline-none  hidden md:flex "
                />
                {/* <CgSearch
                onClick={openSearchModal}
              ...
              /> */}
                <svg
                  ...
                  fill="none"
                  onClick={openSearchModal}
                  className="hidden md:flex absolute left-1 top-1/2 transform -translate-y-1/2 text-gray-800 rounded-full"
                >
                  <path
                    stroke="currentColor"
                    strokeWidth="1.5"
                ...
                {/* <CgSearch
                onClick={openSearchModal}
                className="md:hidden text-gray-800 w-6 h-6 transition-transform"
              /> */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  aria-hidden="true"
